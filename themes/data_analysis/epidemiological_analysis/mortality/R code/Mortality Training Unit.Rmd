...
[6. Maternal Mortality Rate](#maternal-mortality-rate)  
[7. Years of Life Lost (YLL)](#years-of-life-lost-yll)    
[8. Years of Working Life Lost (YWLL)](#years-of-working-life-lost-ywll)  
[9. Mean Age at Death](#mean-age-at-death)  
[Additional: Mean Age at Death by Region]  
[10. Crude Rate of YLL](#crude-rate-of-yll)  
[11. Potential Years of Life Lost (PYLL) and Standardised PYLL (SYLL)](#potential-years-of-life-lost-pyll-and-standardised-pyll-syll)  
...
```{r maternal_mortality_rate, echo=TRUE, message=FALSE, warning=FALSE}
...
## 7. Years of Life Lost (YLL) due to Accidents {#years-of-life-lost-yll}
...
```
## 10. Crude Rate of Years of Life Lost (YLL) due to Accidents {#crude-rate-of-yll}
